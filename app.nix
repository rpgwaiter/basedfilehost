...
in
  ...
  stdenv.mkDerivation rec {
    ...
    meta = with stdenv.lib; {
      description = "BasedFileHost";
      longDescription = "BasedFileHost Easy File Sharing";
      homepage = https://github.com/rpgwaiter/basedfilehost;
